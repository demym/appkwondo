...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_socket_service_socket_service__ = __webpack_require__(19);
...
var HomePage = (function () {
    ...
    HomePage.prototype.getAuth = function (m) {
        ...
        if (questo.backend.user.role == "guest") {
            if (m.name == "Eventi")
                retvalue = false;
            if (m.name == "Statistiche")
                retvalue = false;
        }
        return retvalue;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_backend_backend__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_socket_service_socket_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matchconsolerr_matchconsolerr__ = __webpack_require__(552);
...
var TournamentPage = (function () {
    ...
    TournamentPage.prototype.ionViewWillLeave = function () {
        ...
        this.events.unsubscribe("scoreboard2");
        this.events.unsubscribe("scoreboards2");
    };
    TournamentPage.prototype.ionViewDidLoad = function () {
        ...
        questo.events.subscribe("scoreboards2", function (data) {
            console.log("scoreboards2 received in tournament.ts");
            questo.zone.run(function () {
                questo.refreshScoreboards(function () { });
            });
        });
        questo.events.subscribe("scoreboard2", function (data) {
            console.log("scoreboard2 received in tournament.ts");
            questo.zone.run(function () {
                questo.refreshScoreboards(function () { });
            });
        });
    ...
    TournamentPage.prototype.refreshScoreboards = function (callback) {
        var questo = this;
    ...
    TournamentPage.prototype.refresh = function (callback) {
        ...
        questo.backend.getGara(questo.garaid, function (d) {
            ...
            // questo.gara = data;
            questo.gara = Object.assign({}, data);
            if (data.matchesbyprog.rows.length == 0) {
                var doc = Object.assign({}, questo.gara.gara.rows[0].doc);
                var dd = {
                    doc: doc
                };
                data.matchesbyprog.rows.push(dd);
            }
            console.log("sono qui", questo.gara);
            //questo.jgara = data.gara.rows[0].doc;
    ...
    TournamentPage.prototype.isScore = function () {
        var retvalue = false;
        if (this.backend.user.role == "score")
            retvalue = true;
        return retvalue;
    };
    ...
    TournamentPage.prototype.inputAtletaIscrittoOld = function (girone) {
        ...
        var prompt = questo.alertCtrl.create({
            title: 'Atleta',
            message: "Inserisci un nuovo atleta iscritto",
            inputs: [
                {
                    name: 'cognome',
                    placeholder: 'Cognome'
    ...
    TournamentPage.prototype.deleteAtletaIscritto = function (i) {
        ...
        questo.backend.showConfirm("Sei sicuro di voler cancellare questo atleta dagli iscritti al torneo ?", function (yes) {
            if (yes) {
                var newarr = [];
                questo.torneo.atletiiscritti.forEach(function (item) {
                    if ((item.cognome == i.cognome) && (item.nome == i.nome)) {
                    }
                    else {
                        newarr.push(item);
                    }
                });
                questo.torneo.atletiiscritti = newarr;
                //elimina dai gironi se c'è
                questo.torneo.gironi.forEach(function (item) {
                    var players = item.players;
                    var newplayers = [];
                    players.forEach(function (pitem) {
                        var chiave1 = pitem.cognome.toLowerCase() + pitem.nome.toLowerCase();
                        var chiave2 = i.cognome.toLowerCase() + i.nome.toLowerCase();
                        if (chiave1 == chiave2) {
                        }
                        else
                            newplayers.push(pitem);
                    });
                    item.players = newplayers;
                });
                questo.backend.showToast("Atleta " + i.cognome + " " + i.nome + " eliminato dagli iscritti");
            }
        });
    };
    TournamentPage.prototype.scoreKeeper = function (inc, girone) {
        var questo = this;
        console.log(questo.backend.user.role);
        if (!this.isAdmin() && !this.isSuperAdmin() && !this.isScore()) {
            return;
        }
        console.log("scorekeeper inc", inc);
        var soc1 = "ASD TAEKWONDO ROZZANO";
        var soc2 = "ASD TAEKWONDO ROZZANO";
        if (inc.player1.hasOwnProperty("societa"))
            soc1 = inc.player1.societa;
        if (inc.player2.hasOwnProperty("societa"))
            soc2 = inc.player2.societa;
    ...
    TournamentPage.prototype.inputResult = function (inc, girone, idx) {
        ...
        //if (1==1) return;
        if (!questo.isAdmin() && !questo.isSuperAdmin())
            return;
        var prompt = questo.alertCtrl.create({
            title: 'Risultato',
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        if (data.result.trim() == "") {
                            console.log("esco");
                            var url = questo.backend.rooturl + "/matches/setresultrr/" + questo.jgara.id + "?result=-&order=" + inc.order + "&girone=" + girone.title;
                        ...
                        if (arr.length == 2) {
                            ...
                            inc.punteggio1 = p1;
                            inc.punteggio2 = p2;
                            var url = questo.backend.rooturl + "/matches/setresultrr/" + questo.jgara.id + "?result=" + p1 + "-" + p2 + "&order=" + inc.order + "&girone=" + girone.title;
                            questo.backend.fetchData(url, function (uudata) {
                                console.log("uudata", uudata);
                                questo.backend.showToast("Punteggio incontro impostato su " + value);
                                //questo.doRefresh();
    ...
    TournamentPage.prototype.postLocalChat = function (msg) {
        var questo = this;
        var tim = __WEBPACK_IMPORTED_MODULE_5_moment__().format("YYYYMMDDHHmmSS");
    ...
    TournamentPage.prototype.deleteGirone = function (girone) {
        var questo = this;
        if (!questo.isAdmin())
            return;
        console.log("delete girone", girone);
        var gtitle = girone.title;
        questo.backend.showConfirm("Sei sicuro di voler cancellare questo girone (" + gtitle + ") ?", function (yes) {
            if (yes) {
                var arr = [];
                questo.torneo.gironi.forEach(function (item) {
                    if (item.title != girone.title)
                        arr.push(item);
                });
                questo.torneo.gironi = arr;
                questo.backend.showToast("Girone " + gtitle + " eliminato !");
                console.log("gironi torneo", questo.torneo.gironi);
                questo.activegironeindex = 0;
                questo.activegirone = questo.torneo.gironi[0];
            }
        });
    };
    TournamentPage.prototype.renameGirone = function (g) {
        var questo = this;
        var alert = questo.alertCtrl.create({
            title: 'Rinomina girone',
            inputs: [
                {
                    name: 'gironetitle',
            ...
            buttons: [
                ...
                },
                {
                    text: 'OK',
                    handler: function (data) {
                        g.title = data.gironetitle.toUpperCase();
                    }
                }
            ]
        });
    ...
    TournamentPage.prototype.showMatchconsole = function (m) {
        ...
        m.matchord = matchord;
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__matchconsolerr_matchconsolerr__["a" /* MatchconsolerrPage */], {
            match: m,
            avversari: []
        });
    };
    ...
    TournamentPage.prototype.getSocieta = function (p) {
        //console.log("p",p);
        var societa = "ASD TAEKWONDO ROZZANO";
        if (p.hasOwnProperty("societa"))
            societa = p.societa;
        return societa;
    };
    TournamentPage.prototype.hasGirone = function (s) {
        var retvalue = false;
        if (s.hasOwnProperty("girone")) {
            if (s.girone.hasOwnProperty("title"))
                retvalue = true;
        }
        return retvalue;
    };
    TournamentPage.prototype.selectIscritto = function (girone) {
        var questo = this;
        console.log("questo.girone", girone);
        var alert = this.alertCtrl.create();
        alert.setTitle('Seleziona iscritto');
        var checked = false;
        var rimanenti = [];
        questo.torneo.atletiiscritti.forEach(function (item) {
            var found = false;
        ...
        if (rimanenti.length == 0) {
            questo.backend.showAlert("Tutti gli atleti iscritti sono stati impiegati nei gironi");
            return;
        }
        rimanenti.forEach(function (item) {
            alert.addInput({
                type: 'checkbox',
    ...
    TournamentPage.prototype.isInGironi = function (item) {
        var questo = this;
        var found = false;
        questo.torneo.gironi.forEach(function (gitem) {
            var players = gitem.players;
    ...
    TournamentPage.prototype.getGironeAtleta = function (item) {
        var questo = this;
        var found = false;
        var girone = "";
        questo.torneo.gironi.forEach(function (gitem) {
...
var SocketService = (function () {
    function SocketService(zone, events, backend, badge, platform) {
        var _this = this;
        this.zone = zone;
        this.events = events;
        this.backend = backend;
    ...
    SocketService.prototype.initialize = function () {
        ...
        questo.socket.on("scoreboard", function (data) {
            ...
            questo.zone.run(function () {
                ...
                questo.events.publish('scoreboard2', data);
            });
        });
        this.socket.on("scoreboards", function (data) {
            ...
            questo.events.publish('scoreboards2', data);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_socket_service_socket_service__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_media__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_streaming_media__ = __webpack_require__(114);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic_storage__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tournament_tournament__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_backend_backend__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_gara_gara__ = __webpack_require__(143);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tournament_tournament__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = (function () {
    ...
    RegisterPage.prototype.login = function () {
        ...
        //this.showLoading()
        var logindata = this.registerCredentials;
        logindata.password = logindata.psw;
        if (this.backend.user.gcmtoken) {
            if (this.backend.user.gcmtoken != "") {
                logindata["gcmtoken"] = this.backend.user.gcmtoken;
            }
...
var UsersPage = (function () {
    ...
    UsersPage.prototype.refresh = function (callback) {
        ...
        questo.backend.fetchData(iosurl, function (idata) {
            ...
            questo.backend.fetchData(url, function (data) {
                ...
                if (questo.searchfilter.trim() != "") {
                    data.rows.forEach(function (sitem) {
                        var doc = sitem.doc;
                        var found = false;
                        for (var k in doc) {
                            if (typeof doc[k] === 'string' || doc[k] instanceof String) {
                                if (doc[k].toLowerCase().indexOf(questo.searchfilter.toLowerCase()) > -1) {
                                    found = true;
                                }
                            }
                        }
    ...
    UsersPage.prototype.addUser = function () {
        var questo = this;
        var d = new Date();
        var m = __WEBPACK_IMPORTED_MODULE_4_moment__(d).format("YYYYMMDDHHmmss");
        var u = {
            doc: {
                "email": "",
                "nickname": "",
        ...
        var profileModal = questo.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_3__pages_useredit_useredit__["a" /* UsereditPage */], { user: u, mode: "add" });
        profileModal.onDidDismiss(function (data) {
            console.log(data);
            if (data == "saved")
                questo.doRefresh();
    ...
    UsersPage.prototype.onInput = function (ev) {
        console.log("oninput", this.searchfilter);
        this.doRefresh();
    };
    UsersPage.prototype.onCancel = function (ev) {
    };
    return UsersPage;
}());
...
var UsereditPage = (function () {
    ...
    UsereditPage.prototype.save = function () {
        ...
        var doc = questo.user;
        if (questo.mode == "add")
            url = questo.backend.rooturl + "/users/add";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_backend_backend__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_socket_service_socket_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__scorekeeper_scorekeeper__ = __webpack_require__(81);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ScoreboardsPage = (function () {
    function ScoreboardsPage(zone, socket, events, backend, navCtrl, navParams) {
        this.zone = zone;
        this.socket = socket;
        this.events = events;
        this.backend = backend;
    ...
    ScoreboardsPage.prototype.ionViewDidEnter = function () {
        var questo = this;
    ...
    ScoreboardsPage.prototype.hasGirone = function (s) {
        var retvalue = false;
        if (s.hasOwnProperty("girone")) {
            if (s.girone.hasOwnProperty("title"))
                retvalue = true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_badge__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_local_notifications__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_background_mode__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_streaming_media__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_media__ = __webpack_require__(115);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BackendProvider = (function () {
  ...
  */
    ...
    */
    ...
    BackendProvider.prototype.removeScoreboard = function (sockid, callback) {
        var questo = this;
    ...
    BackendProvider.prototype.getTimeMMSS = function (totalseconds) {
        var t = totalseconds;
...
var MyApp = (function () {
    ...
    MyApp.prototype.isVisibleMenu = function (text) {
        ...
        if (questo.backend.user.role == "guest") {
            var guestpages = ["scoreboards", "informazioni", "logout", "chiudi appkwondo"];
            if (guestpages.indexOf(t) == -1)
                retvalue = false;
        }
...
var ScorekeeperPage = (function () {
    ...
    ScorekeeperPage.prototype.ionViewDidLeave = function () {
        ...
        if (questo.mode == "slave")
            questo.events.unsubscribe("scoreboardslave");
        if (questo.mode == "master")
            questo.backend.removeScoreboard(questo.socket.socket.id, function () {
            });
    };
    ScorekeeperPage.prototype.ionViewDidEnter = function () {
        ...
        if (String(questo.scoreboard.punt2).trim() == "")
    ...
    ScorekeeperPage.prototype.getTime = function (totalseconds) {
        var t = totalseconds;
        var sec_num = parseInt(t, 10); // don't forget the second param
        var hours = Math.floor(sec_num / 3600);
        var minutes = Math.floor((sec_num - (hours * 3600)) / 60);
...
ScorekeeperPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* ViewController */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_3__providers_socket_service_socket_service__["a" /* SocketService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__providers_backend_backend__["a" /* BackendProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */]])
], ScorekeeperPage);
