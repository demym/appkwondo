...
var TournamentPage = (function () {
    function TournamentPage(socket, events, alertCtrl, backend, navCtrl, navParams) {
        this.socket = socket;
        this.events = events;
        this.alertCtrl = alertCtrl;
        this.backend = backend;
