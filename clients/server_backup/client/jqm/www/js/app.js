...
function recordAudio() {
	 ...
	 if (recording) {
		 ...
		 $("#gara #popResult a#recordaudio").text("RECORD").button("refresh")
		 $("#gara #popResult a#recordaudio").css("background","red");
		 recorder.stop();
		 recorder.playback();
	 }	 
	 if (!recording) {

		 $("#gara #popResult a#recordaudio").text("RECORDING").button("refresh")
		 $("#gara #popResult a#recordaudio").css("background","silver");
		 recorder.record();  
