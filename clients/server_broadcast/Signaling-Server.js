...
module.exports = exports = function(app, socketCallback) {
    ...
    function onConnection(socket) {
        ...
        socket.on("refreshPublicModerators",function(data){
            //console.log("rpm");
            socket.broadcast.emit("refreshPublicModerators");
        })
...
/*
        socket.on("getviewers",function(data){
            var userid=data.roomid;
            console.log("socket getviewers for room "+roomid);
             if (listOfUsers[data.roomid]) {
                    for (var s in listOfUsers[data.roomid].connectedWith) {
                        console.log(s);
                    }
             }
