// RTCMultiConnection-v3 MUST be loaded after when device is ready.


function rtcEvent(evname,data){

 var myEvent = new CustomEvent("rtcevent", {
	detail: {
        evname: evname,
		data: data
	},
...
function loadRTCMultiConnection() {
    ...
    function RTCMultiConnection(roomid, forceOptions) {
        ...
        connection.onmessage = function(event) {
            console.log('data-message', event.userid, event.data);
            if (!!connection.enableLogs) {
        ...
        connection.onleave = function(userid) {
            console.log("userid "+userid+" left the room");
            rtcEvent("userleft",{
        ...
        connection.setCustomSocketEvent = function(customEvent) {
            console.log("called customsocketevent");
            if (customEvent) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        connection.socket.on("refreshPublicModerators",function(){
            console.log("receivedrpm");
            rtcEvent("rpm");
        })
        ...
        connection.socket.on('connect', function() {
            if (alreadyConnected) {
                conslog("socket.on connect, already connected");
                return;
            }
        ...
        connection.socket.on('password-max-tries-over', function(remoteUserId) {
         ...
         connection.socket.on('rpm', function(remoteUserId) {
            conslog("rpm");
        });
        ...
        connection.socket.on('user-disconnected', function(remoteUserId) {
            ...
            console.log("user "+remoteUserId+" disconnected from the broadcast");
            rtcEvent("useroffline",{
                uid: remoteUserId
            });
            connection.onUserStatusChanged({
                userid: remoteUserId,
        ...
        connection.socket.on('user-connected', function(userid) {
            ...
            console.log("user "+userid+" connected to the broadcast");
            rtcEvent("useronline",{
                uid: userid
            });
        ...
        connection.socket.on('number-of-broadcast-viewers-updated', function(data) {
            console.log("broadcast users changed");
