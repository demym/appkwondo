...
import { Tabs, Tab, Segment, SegmentButton } from 'ionic-angular'
...
export class ScrollableSegments implements AfterViewInit {
  @Input('scrollable-segments') ionSeg: Segment;
  @Input('opts') opts: any = {};
  ...
  ngAfterViewInit() {
   ...
   // this.nativeTabbar = this.ionSeg.nativeElement;
    ...
    this.ionSeg.ionChange.subscribe(() => {
      console.log("cucuzza");
      this.scrollToselectedTab();
    })
