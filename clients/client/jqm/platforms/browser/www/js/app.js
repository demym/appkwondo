...
function refreshChat(slf) {
	...
	var url = rooturl + "/chat/getno64/" + jcurrentgara.id;
	if (!chatmultiroom) url = rooturl + "/chat/getno64";
...
function sortStats(tipostat) {
	...
	if (tipostat == "gare") ranking_sortcampo="garedisputate";
	if (tipostat == "ori") ranking_sortcampo="ori";
	if (tipostat == "argenti") ranking_sortcampo="argenti";
	if (tipostat == "bronzi") ranking_sortcampo="bronzi";
	*/
