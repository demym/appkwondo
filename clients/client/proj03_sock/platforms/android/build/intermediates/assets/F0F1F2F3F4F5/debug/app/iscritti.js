...
exports.iscrittiTap = function (args) {
	...
	var ret = global.filterRows(parms.gara.matchesbyprog, {
		atletaid: aid
	});
	...
	ret.tkdt = parms.gara.gara.rows[0].doc.tkdt;
	ret.garadata=parms.gara.gara.rows[0].doc.data;
...
function refreshIscritti() {
	...
	for (var i = 0; i < arr.length; i++) {
		...
		var $mfa = global.filterRows(parms.gara.matchesbyprog, {
			"atletaid": arr[i]
		}, true);
		var atl = global.getAtletaById(arr[i]);
