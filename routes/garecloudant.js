...
router.get("/findall",function(req,res){
    dbscl.list("atleti",function(adata){
        var atleti=adata.rows;
        dbscl.list("gare",function(data){
            var retvalue={
                atleti: atleti,
                gare: data.rows
            }
...
router.get('/findall_old', function (req, res) {
	var societa = "";
	if (req.query) {
	...
	//readGareJson(function(){
        dbscl.list("gare",function(allmongo){
	//mongo.getallfiles(function (allmongo) {
